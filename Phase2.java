public class Phase2 {
    public static void main(String[] args) {
        ...
        BstAlbum album1 = new BstAlbum("Album1", "bear AND animal", manager);
        BstAlbum album2 = new BstAlbum("Album2", "animal AND grass", manager);
        BstAlbum album3 = new BstAlbum("Album3", "", manager);
  ...
  //You can get the list of photos in album2 by calling album2.getPhotos().
        ...
        System.out.println("\n\nGet album3 name, condition, and photos:");
        System.out.println("album1 name: " + album3.getName());
        System.out.println("album1 condition: " + album3.getCondition());
         //You can get the list of photos in album2 by calling album2.getPhotos().
        LinkedList<Photo> photos1 = album3.getPhotos();
        //You can write a method that prints the list of photos in album2.
        System.out.println(album3.getCondition());
